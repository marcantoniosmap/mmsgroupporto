...
function Home(props){
    ...
    const sliderContent_en=[
        ...
        Textline2 : 'We Grow With Certainity',
        Paragraph : 'Through strong vision and mission, our company expands and grows sustainably for the betterment of Indonesia',
        CTA : 'About Us',
        CTAlink : '/about',
        },
        ...
        Textline2 : 'We Devote to The Nation',
        Paragraph : 'Starting from the coal business, MMSGI embodies its devotion to the country through 3 business pillars: MMS Resources, MMS Land, and MMS Solution',
        CTA : 'Our Business',
        CTAlink : '/business/resources',
        },

        {imageUrl: '/img/MMS/slider-3.png',
        Textline1 : 'Through Various Initiatives,',
        Textline2 : 'We Contribute To The Country',
        Paragraph : 'We support the sustainable development of the society through various initiatives to inspire compassion among each other',
        CTA : 'CSR',
        CTAlink : '/csr',
        },
    ]
