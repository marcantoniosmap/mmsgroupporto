                                    ...
                                    <div className='tab-content'>
                                            ...
                                            {    containerSegment.map((content,index)=>
                                                    <div class="px-3">
                                                        ...
                                                        <span class="text-7 text-color-dark font-weight-bold negative-ls-2 mb-2" >{content.title}</span>
                                                        
                                                                <p className='pb-0 pt-3 text-4' style={{whiteSpace:'pre-line'}}>{content.paragraph}</p>
                                                    </div>
                                            )}
                                                </Slider>
                                    </div>
